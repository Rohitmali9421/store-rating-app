              ...
              <div className="md:col-span-2">
                ...
                <input
                  {...register('ownerAddress', {
                    required: "Owner's address is required",
                    maxLength: { value: 400, message: 'Max 400 characters' }
                  })}
              ...
              <div className="relative md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 px-3 flex items-center text-gray-500 top-5"
                  >
        ...
        <>
          <div className="bg-white rounded-xl shadow-md overflow-hidden mb-6">
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-100">
                  {stores.map((store, index) => (
                    <tr
                      key={store.id}
                      className={`transition-colors group ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'
                        } hover:bg-blue-50`}
                    >
                      <td className="p-4">
                      ...
                      <td className="p-4 text-gray-600">
                        <div className="max-w-[200px] truncate" title={store.email}>
                          {store.email}
                        </div>
                      </td>
                      <td className="p-4 text-gray-600">
                        <div className="max-w-[200px] truncate" title={store.address}>
                          {store.address}
                        </div>
                      </td>
                      <td className="p-4">
            ...
            <div className="px-4 py-3 bg-gray-50 border-t border-gray-100 text-sm text-gray-500 flex justify-between items-center">
              ...
              <div>
                Showing {stores.length} of {pagination?.totalItems || 0} stores
              </div>
            </div>
          </div>
